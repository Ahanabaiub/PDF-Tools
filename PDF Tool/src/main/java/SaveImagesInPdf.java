...
public class SaveImagesInPdf extends PDFStreamEngine
{
    ...
    public static void main( String[] args ) throws IOException
    {
        ...
        String fileName = "F:\\Shieam\\My programmes\\JAVA\\PDF PArser\\apache.pdf";
        try
        {
    ...
    protected void processOperator( Operator operator, List<COSBase> operands) throws IOException
    {
        ...
        if( "Do".equals(operation) )
        {
            ...
            if( xobject instanceof PDImageXObject)
            {
                ...
                ImageIO.write(bImage,"PNG",new File("F:\\Shieam\\My programmes\\JAVA\\PDF PArser\\img\\image_"+imageNumber+".png"));
